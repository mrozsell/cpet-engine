...
{rows}</table>"""
    ...
    def build_canon_table(df, results: 'Dict[str, Any]', cfg) -> 'Dict[str, Any]':
        ...
        _e09 = results.get('E09', {})
        ct['BR_pct'] = _e09.get('br_pct')
        ct['vent_br_abs_lmin'] = _e09.get('br_abs_lmin')
        ct['vent_mvv_lmin'] = _e09.get('mvv_lmin')
        ct['vent_mvv_source'] = _e09.get('mvv_source')
        ct['vent_ve_mvv_ratio'] = _e09.get('ve_mvv_ratio')
        ct['vent_limitation'] = _e09.get('ventilatory_limitation')
        ct['vent_spiro_pattern'] = _e09.get('spiro_pattern')
        ct['vent_vt_fvc_ratio'] = _e09.get('vt_fvc_ratio')
        ct['vent_small_airway_flag'] = _e09.get('small_airway_flag')
        ct['spiro_fev1_l'] = _e09.get('fev1_l')
        ct['spiro_fvc_l'] = _e09.get('fvc_l')
        ct['spiro_fev1_fvc'] = _e09.get('fev1_fvc_ratio')
        ct['spiro_fev1_pct_pred'] = _e09.get('fev1_pct_pred')
        ct['spiro_fef2575_zscore'] = _e09.get('fef2575_zscore')
