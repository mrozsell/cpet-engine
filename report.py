...
@media print{{body{{background:white;}} .wrap{{max-width:100%;padding:8px;}} .card{{break-inside:avoid;}}}}
  ...
  <div>
    <div style="font-size:11px;color:#64748b;margin-bottom:2px;">Raport z badania wydolnościowego</div>
  ...
  <div style="display:flex;align-items:center;gap:16px;">
    ...
    <img src="data:image/svg+xml;base64,{_logo_pro}" style="height:50px;opacity:0.85;" alt="Logo">
  </div>
</div>'''
        ...
        try:
            ...
            if _vt1p > 0:
                ...
                if _profile_pro['flags']['vt1_ceiling_trap']:
                    _vt1_t += f' \u2014 wysoki %VO\u2082max ale niski pułap absolutny (~{_profile_pro["pctile_val"]:.0f} percentyl). Baza "pozornie dobra".'
